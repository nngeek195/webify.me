...
class AdminPanel extends Component {
    ...
    fetchCurrentApiKeys = async () => {
        try {
            const response = await fetch('https://jose-flux-founded-move.trycloudflare.com/admin/api-keys');
    ...
    handleTestApiKeys = async (testGemini = false, testUnsplash = false) => {
        ...
        try {
            const response = await fetch('https://jose-flux-founded-move.trycloudflare.com/admin/test-api-keys', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    fetchAllNotifications = async () => {
        try {
            const response = await fetch('https://jose-flux-founded-move.trycloudflare.com/admin/notifications');
            const data = await response.json();
    ...
    fetchUsers = async () => {
        try {
            const response = await fetch('https://jose-flux-founded-move.trycloudflare.com/users');
            const data = await response.json();
    ...
    fetchStats = async () => {
        try {
            ...
            const activeUsersRes = await fetch('https://jose-flux-founded-move.trycloudflare.com/users/active_count');
            const activeUsersData = await activeUsersRes.json();

            // Fetch notifications stats
            const notificationsStatsRes = await fetch('https://jose-flux-founded-move.trycloudflare.com/notifications/stats');
    ...
    handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://jose-flux-founded-move.trycloudflare.com/admin/sendEmailNotification', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
