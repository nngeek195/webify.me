...
class SignUp extends Component {
    ...
    checkEmailExists = async (email) => {
        ...
        try {
            const response = await fetch(`https://jose-flux-founded-move.trycloudflare.com/checkEmail/${encodeURIComponent(email)}`);
    ...
    checkUsernameExists = async (username) => {
        ...
        try {
            const response = await fetch(`https://jose-flux-founded-move.trycloudflare.com/checkUsername/${encodeURIComponent(username)}`);
            const data = await response.json();
    ...
    handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://jose-flux-founded-move.trycloudflare.com/signup', {
                method: 'POST',
                headers: {
